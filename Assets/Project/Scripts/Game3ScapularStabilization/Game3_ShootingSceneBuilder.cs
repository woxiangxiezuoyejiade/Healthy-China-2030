...
public class Game3_ShootingSceneBuilder : MonoBehaviour
{
    ...
    // ===== 配色（从参考图提取） =====
    static readonly Color COLOR_GROUND        = new Color(0.17f, 0.50f, 0.22f);     // 绿色地面
    ...
    static readonly Color COLOR_SKY           = new Color(0.50f, 0.78f, 0.97f);     // 天空天蓝色
    ...
    void BuildPurpleTargets()
    {
        ...
        {
            CreatePillTarget(pos[0], pos[1], 0.5f, 1.8f, COLOR_TARGET_PURPLE,
    ...
    void BuildRedTargets()
    {
        ...
        foreach (float[] pos in positions)
        {
            CreatePillTarget(pos[0], pos[1], 0.28f, 1.0f, COLOR_TARGET_RED,
    ...
    void BuildWeapon()
    {
        ...
        baseObj.transform.localPosition = new Vector3(0f, 0.85f, 0f);
        ...
        body.transform.localPosition = new Vector3(0.12f, 0.78f, 0.55f);
        body.transform.localScale = new Vector3(0.36f, 0.36f, 0.96f);
        ...
        muzzle.transform.localPosition = new Vector3(0.12f, 0.78f, 0.98f);
    ...
    void ConfigureLighting()
    {
        ...
        dirLight.intensity = 1.0f;                       // 降低顶光，避免顶部过亮
        dirLight.transform.rotation = Quaternion.Euler(35f, -30f, 0f);

        // 环境光提亮（偏绿，让地面在 Game 里也保持绿色）
        RenderSettings.ambientMode = UnityEngine.Rendering.AmbientMode.Flat;
        RenderSettings.ambientLight = new Color(0.88f, 0.96f, 0.86f);
        ...
        fillLight.color = new Color(0.92f, 0.98f, 0.92f);
